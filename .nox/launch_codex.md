...
- The selected role is stored in `.nox/multi-agent/.runtime/codex_app_current_role.json`.
...
cat .nox/multi-agent/.runtime/codex_app_current_role.json
```
...
2. LOAD instructions from `./.nox/multi-agent/core/shared_architect.md`, `./.nox/multi-agent/core/codex_app_chat.md`, and `./.nox/multi-agent/core/shared_global_rules.md`.
3. ENSURE HEARTBEAT: create or update a Codex.app heartbeat for this current thread every 2 minutes. The heartbeat must read `./.nox/multi-agent/.runtime/codex_app_current_role.json` on every wake and follow the selected role.
4. ROLE = Architect.
5. NOW AND ON EVERY HEARTBEAT: read `./.nox/multi-agent/.runtime/codex_app_current_role.json` and confirm selected role is Architect.
6. Read `./multi-agent.tasks.txt` directly.
7. If `./multi-agent.tasks.txt` is empty, write/update `./.nox/multi-agent/.runtime/codex_app_architect.state.json` as polling and output only `[POLLING]`.
...
2. LOAD instructions from `./.nox/multi-agent/core/shared_designer.md`, `./.nox/multi-agent/core/codex_app_chat.md`, and `./.nox/multi-agent/core/shared_global_rules.md`.
3. ENSURE HEARTBEAT: create or update a Codex.app heartbeat for this current thread every 2 minutes. The heartbeat must read `./.nox/multi-agent/.runtime/codex_app_current_role.json` on every wake and follow the selected role.
4. ROLE = Designer.
5. NOW AND ON EVERY HEARTBEAT: read `./.nox/multi-agent/.runtime/codex_app_current_role.json` and confirm selected role is Designer.
6. Read `./.nox/multi-agent/status.json` directly.
7. If `Designer` is not `ready` in `./.nox/multi-agent/status.json`, write/update `./.nox/multi-agent/.runtime/codex_app_designer.state.json` as polling and output only `[POLLING]`.
...
2. LOAD instructions from `./.nox/multi-agent/core/shared_developer.md`, `./.nox/multi-agent/core/codex_app_chat.md`, and `./.nox/multi-agent/core/shared_global_rules.md`.
3. ENSURE HEARTBEAT: create or update a Codex.app heartbeat for this current thread every 2 minutes. The heartbeat must read `./.nox/multi-agent/.runtime/codex_app_current_role.json` on every wake and follow the selected role.
4. ROLE = Developer.
5. NOW AND ON EVERY HEARTBEAT: read `./.nox/multi-agent/.runtime/codex_app_current_role.json` and confirm selected role is Developer.
6. Read `./.nox/multi-agent/status.json` directly.
7. If `Developer` is not `ready` in `./.nox/multi-agent/status.json`, write/update `./.nox/multi-agent/.runtime/codex_app_developer.state.json` as polling and output only `[POLLING]`.
...
2. LOAD instructions from `./.nox/multi-agent/core/shared_tester.md`, `./.nox/multi-agent/core/codex_app_chat.md`, and `./.nox/multi-agent/core/shared_global_rules.md`.
3. ENSURE HEARTBEAT: create or update a Codex.app heartbeat for this current thread every 2 minutes. The heartbeat must read `./.nox/multi-agent/.runtime/codex_app_current_role.json` on every wake and follow the selected role.
4. ROLE = Tester.
5. NOW AND ON EVERY HEARTBEAT: read `./.nox/multi-agent/.runtime/codex_app_current_role.json` and confirm selected role is Tester.
6. Read `./.nox/multi-agent/status.json` directly.
7. If `Tester` is not `ready` in `./.nox/multi-agent/status.json`, write/update `./.nox/multi-agent/.runtime/codex_app_tester.state.json` as polling and output only `[POLLING]`.
...
1. LOAD instructions from `./.nox/multi-agent/core/shared_architect.md`, `./.nox/multi-agent/core/codex_architect.md`, and `./.nox/multi-agent/core/shared_global_rules.md`.
2. OBSERVE 'BLOOD SILENT' MANDATE: NO chat, NO thoughts, NO summaries.
3. EXECUTE IMMEDIATE: `python3 .nox/multi-agent/core/codex_wait_for_task.py`
4. DO NOT TALK. GO.
```
...
1. LOAD instructions from `./.nox/multi-agent/core/shared_designer.md`, `./.nox/multi-agent/core/codex_designer.md`, and `./.nox/multi-agent/core/shared_global_rules.md`.
2. OBSERVE 'BLOOD SILENT' MANDATE: NO chat, NO thoughts, NO summaries.
3. EXECUTE IMMEDIATE: `python3 .nox/multi-agent/core/codex_wait_for_status.py Designer ready`
4. DO NOT TALK. GO.
```
...
1. LOAD instructions from `./.nox/multi-agent/core/shared_developer.md`, `./.nox/multi-agent/core/codex_developer.md`, and `./.nox/multi-agent/core/shared_global_rules.md`.
2. OBSERVE 'BLOOD SILENT' MANDATE: NO chat, NO thoughts, NO summaries.
3. EXECUTE IMMEDIATE: `python3 .nox/multi-agent/core/codex_wait_for_status.py Developer ready`
4. DO NOT TALK. GO.
```
...
1. LOAD instructions from `./.nox/multi-agent/core/shared_tester.md`, `./.nox/multi-agent/core/codex_tester.md`, and `./.nox/multi-agent/core/shared_global_rules.md`.
2. OBSERVE 'BLOOD SILENT' MANDATE: NO chat, NO thoughts, NO summaries.
3. EXECUTE IMMEDIATE: `python3 .nox/multi-agent/core/codex_wait_for_status.py Tester ready`
4. DO NOT TALK. GO.
```
