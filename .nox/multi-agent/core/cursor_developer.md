...
## SCRIPTS:
- Polling Status: `python3 .nox/multi-agent/core/cursor_wait_for_status.py Developer ready`
...
Monitor(
  ...
  command="while true; do
    dev_status=$(python3 -c \"import json; d=json.load(open('.nox/multi-agent/status.json')); print(next(r['status'] for r in d['pipeline'] if r['role']=='Developer'))\" 2>/dev/null) || true
