...
- Trust and follow [shared_tester.md](./.nox/multi-agent/core/shared_tester.md).
...
```bash
python3 .nox/multi-agent/core/codex_wait_for_status.py Tester ready
```

When the script exits with `CODEX_SIGNAL_RECEIVED`, proceed to Step 2 of [shared_tester.md](./.nox/multi-agent/core/shared_tester.md).
...
3. Follow [shared_tester.md](./.nox/multi-agent/core/shared_tester.md), applying the Codex execution model above wherever shared instructions mention host-specific tooling.
