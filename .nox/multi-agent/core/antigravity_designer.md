...
3. Follow the logic in [shared_designer.md](./.nox/multi-agent/core/shared_designer.md).

## SCRIPTS:
- Polling Status: `python3 .nox/multi-agent/core/antigravity_wait_for_status.py Designer ready`
