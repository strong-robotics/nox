...
- Trust and follow [shared_developer.md](./.nox/multi-agent/core/shared_developer.md).
...
## Scripts
- Polling Status: `python3 .nox/multi-agent/core/codex_wait_for_status.py Developer ready`
...
3. Follow [shared_developer.md](./.nox/multi-agent/core/shared_developer.md), applying the Codex execution model above wherever shared instructions mention host-specific tooling.
