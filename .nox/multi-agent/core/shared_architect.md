...
## FILE OUTPUTS ONLY:
- `implementation_plan.md` (in `./.nox/multi-agent/core/artifacts/`)
- `task.md` (in `./.nox/multi-agent/core/artifacts/`)
...
- Only `./.nox/multi-agent/core/artifacts/` is allowed.
...
1. **Read Current State**: `cat ./.nox/multi-agent/status.json`

2. **Check for Busy Agents**:
  - **IF** Designer status is `"in_progress"` OR `"ready"`:
    - **Antigravity**: `python3 .nox/multi-agent/core/antigravity_wait_for_status.py Designer completed`
    - **Codex**: `python3 .nox/multi-agent/core/codex_wait_for_status.py Designer completed`
  ...
  - **IF** Developer status is `"in_progress"` OR `"ready"`:
    - **Antigravity**: `python3 .nox/multi-agent/core/antigravity_wait_for_status.py Developer completed`
    - **Codex**: `python3 .nox/multi-agent/core/codex_wait_for_status.py Developer completed`
  ...
  - **IF** Tester status is `"in_progress"` OR `"ready"`:
    - **Antigravity**: `python3 .nox/multi-agent/core/antigravity_wait_for_status.py Tester completed`
    - **Codex**: `python3 .nox/multi-agent/core/codex_wait_for_status.py Tester completed`
...
- Run: `python3 .nox/multi-agent/core/archive_task.py <TASK_ID> completed`
- Run: `python3 .nox/multi-agent/core/pop_task.py`
...
6. ✅ Create detailed `task.md`:
   ...
   - Key insights
   - Recommendations
7. ✅ Run `python3 .nox/multi-agent/core/archive_task.py <TASK_ID> completed`
8. ✅ Run `python3 .nox/multi-agent/core/pop_task.py`
