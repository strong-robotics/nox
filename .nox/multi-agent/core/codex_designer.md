...
- Trust and follow [shared_designer.md](./.nox/multi-agent/core/shared_designer.md).
...
## Scripts
- Polling Status: `python3 .nox/multi-agent/core/codex_wait_for_status.py Designer ready`
...
3. Follow [shared_designer.md](./.nox/multi-agent/core/shared_designer.md), applying the Codex execution model above wherever shared instructions mention host-specific tooling.
