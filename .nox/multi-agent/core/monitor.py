...
NOX_ROOT     = CORE_DIR.parent.parent
PROJECT_ROOT = NOX_ROOT.parent

STATUS_FILE        = NOX_ROOT / "multi-agent/status.json"
TASKS_FILE         = PROJECT_ROOT / "multi-agent.tasks.txt"
HISTORY_INDEX_FILE = NOX_ROOT / "multi-agent/core/history/index.json"
RUNTIME_DIR        = NOX_ROOT / "multi-agent/.runtime"
