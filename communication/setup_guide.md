...
```bash
python3 communication/speak_orchestrator.py --interval 3
```
...
```bash
python3 communication/wait_for_status.py "Cursor" "ready" --require-nonempty --enforce-speak-turn
...
```bash
python3 communication/wait_for_status.py "Cursor" "ready"
```
