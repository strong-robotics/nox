...
4. **Implementation**: 🔴 **SILENCE** 🔴
   ...
   - **🔴 CRITICAL 🔴**: NEVER create artifacts in any external or IDE-private directory. Multi-agent artifacts MUST be portable across machines via git. Only `./multi-agent/core/artifacts/` is allowed.
